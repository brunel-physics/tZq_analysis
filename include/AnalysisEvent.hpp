...
public :
   ...
   std::array<Float_t, NELECTRONSMAX> elePF2PATMVAcategory;
   std::array<Float_t, NELECTRONSMAX> elePF2PATNonTrigMVA;
   std::array<Float_t, NELECTRONSMAX> elePF2PATNonTrigMVAcategory;
   ...
   std::array<Float_t,  NJETSMAX> jetPF2PATCvsLDiscriminator;
   std::array<Float_t,  NJETSMAX> jetPF2PATCvsBDiscriminator;
...
void AnalysisEvent::Init(bool isMC, std::string triggerFlag, TTree *tree, bool is2016, bool hasMetTriggers)
{
   ...
   fChain->SetBranchAddress("elePF2PATMVA", elePF2PATMVA.data(), &b_elePF2PATMVA);
   ...
   if( is2016 ) fChain->SetBranchAddress("elePF2PATDeltaEtaSeedSC", elePF2PATDeltaEtaSeedSC.data(), &b_elePF2PATDeltaEtaSeedSC);
...
//   fChain->SetBranchAddress("jetPF2PATCvsLDiscriminator", jetPF2PATCvsLDiscriminator.data(), &b_jetPF2PATCvsLDiscriminator);
//   fChain->SetBranchAddress("jetPF2PATCvsBDiscriminator", jetPF2PATCvsBDiscriminator.data(), &b_jetPF2PATCvsBDiscriminator);
   ...
   // 2016 triggers and MET filters
     ...
     fChain->SetBranchAddress("HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v4", &HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v4, &b_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v3);
     ...
     fChain->SetBranchAddress("HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v6", &HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v6, &b_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v3);
     //MET trigger branches
     if (hasMetTriggers) {
