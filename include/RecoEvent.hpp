...
#ifndef _RecoEvent_hpp_
#define _RecoEvent_hpp_
...
public :
   ...
   Float_t         looseJetPF2PATCvsLDisc[40];   //[numLooseCJetsPF2PAT]
   Float_t         looseJetPF2PATCvsBDisc[40];   //[numLooseCJetsPF2PAT]
   ...
   TBranch        *b_looseJetPF2PATCvsLDisc;   //!
   TBranch        *b_looseJetPF2PATCvsBDisc;   //!
   ...
   RecoEvent(bool isMC = true, std::string triggerFlag = "", TTree *tree=0);
   virtual ~RecoEvent();
...
#ifdef RecoEvent_cxx
RecoEvent::RecoEvent(bool isMC, std::string triggerFlag, TTree *tree) : fChain(0) 
{
...
Int_t RecoEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RecoEvent::LoadTree(Long64_t entry)
{
...
void RecoEvent::Init(bool isMC, std::string triggerFlag, TTree *tree)
{
...
void RecoEvent::Show(Long64_t entry)
{
...
Int_t RecoEvent::Cut(Long64_t entry)
{
