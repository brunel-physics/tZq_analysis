...
class MvaEvent
{
    ...
    MvaEvent(bool isMC = true,
             ...
             TTree* tree = nullptr,
             bool is2016 = false,
             bool hasMetTriggers = false);
    virtual ~MvaEvent();
    virtual Int_t Cut(Long64_t entry);
    virtual Int_t GetEntry(Long64_t entry);
    virtual Long64_t LoadTree(Long64_t entry);
    virtual void Init(bool isMC,
                      std::string triggerFlag,
                      TTree* tree,
                      bool is2016,
                      bool hasMetTriggers);
...
Int_t MvaEvent::GetEntry(Long64_t entry)
{
...
Long64_t MvaEvent::LoadTree(Long64_t entry)
{
...
void MvaEvent::Show(Long64_t entry)
{
...
Int_t MvaEvent::Cut(Long64_t entry)
{
