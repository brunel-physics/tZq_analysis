...
def setupBranches(tree,varMap):
    tree.Branch("EvtWeight", varMap["eventWeight"], "tree_EvtWeight/F")
    tree.Branch("mTW", varMap["mTW"], "tree_mTW/F")
    tree.Branch("wQuark1Pt", varMap["wQuark1Pt"], "tree_wQuark1Pt/F")
    tree.Branch("wQuark1Eta", varMap["wQuark1Eta"], "tree_wQuark1Eta/F")
    tree.Branch("wQuark1Phi", varMap["wQuark1Phi"], "tree_wQuark1Phi/F")
    tree.Branch("wQuark2Pt", varMap["wQuark2Pt"], "tree_wQuark2Pt/F")
    tree.Branch("wQuark2Eta", varMap["wQuark2Eta"], "tree_wQuark2Eta/F")
    tree.Branch("wQuark2Phi", varMap["wQuark2Phi"], "tree_wQuark2Phi/F")
    tree.Branch("met",varMap["met"],"tree_met/F")
    tree.Branch("NJets",varMap["nJets"],"tree_NJets/F")
    tree.Branch("leadJetPt",varMap["leadJetPt"],"tree_leadJetPt/F")
    ...
    tree.Branch("NBJets",varMap["nBjets"],"tree_NBJets/F")
    tree.Branch("btagDiscri",varMap["bTagDisc"],"btagDiscri/F")
    tree.Branch("lep1Pt",varMap["lep1Pt"],"tree_lep1Pt/F")
    tree.Branch("lep1Eta",varMap["lep1Eta"],"tree_lep1Eta/F")
    tree.Branch("lep1Phi",varMap["lep1Phi"],"tree_lep1Phi/F")
    tree.Branch("lep1RelIso",varMap["lep1RelIso"],"tree_lep1RelIso/F")
    tree.Branch("lep1D0",varMap["lep1D0"],"tree_lep1D0/F")
    tree.Branch("lep2Pt",varMap["lep2Pt"],"tree_lep2Pt/F")
    tree.Branch("lep2Eta",varMap["lep2Eta"],"tree_lep2Eta/F")
    tree.Branch("lep2Phi",varMap["lep2Phi"],"tree_lep2Phi/F")
    tree.Branch("lep2RelIso",varMap["lep2RelIso"],"tree_lep2RelIso/F")
    tree.Branch("lep2D0",varMap["lep2D0"],"tree_lep2D0/F")
    tree.Branch("lepMass",varMap["lepMass"],"tree_lepMass/F")
    tree.Branch("lepPt",varMap["lepPt"],"tree_lepPt/F")
    tree.Branch("lepEta",varMap["lepEta"],"tree_lepEta/F")
    tree.Branch("lepPhi",varMap["lepPhi"],"tree_lepPhi/F")
    tree.Branch("zMass",varMap["zMass"],"tree_zMass/F")
    tree.Branch("Zpt",varMap["zPt"],"tree_Zpt/F")
    tree.Branch("Zeta",varMap["zEta"],"tree_Zeta/F")
    tree.Branch("Zphi",varMap["zPhi"],"tree_Zphi/F")
    tree.Branch("topMass",varMap["topMass"],"tree_topMass/F")
    tree.Branch("topPt",varMap["topPt"],"tree_topPt/F")
    tree.Branch("topEta",varMap["topEta"],"tree_topEta/F")
    tree.Branch("topPhi",varMap["topPhi"],"tree_topPhi/F")
    tree.Branch("jjdelR",varMap["j1j2delR"],"tree_jjdelR/F")
    tree.Branch("jjdelPhi",varMap["j1j2delPhi"],"tree_jjdelPhi/F")
    tree.Branch("zLepdelR",varMap["zLepdelR"],"tree_zLepdelR/F")
    tree.Branch("zLepdelPhi",varMap["zLepdelPhi"],"tree_zLepdelPhi/F")
    tree.Branch("zlb1DelR",varMap["zlb1DelR"],"tree_zlb1DelR/F")
    tree.Branch("zlb1DelPhi",varMap["zlb1DelPhi"],"tree_zlb1DelPhi/F")
    tree.Branch("zlb2DelR",varMap["zlb2DelR"],"tree_zlb2DelR/F")
    tree.Branch("zlb2DelPhi",varMap["zlb2DelPhi"],"tree_zlb2DelPhi/F")
    tree.Branch("lepHt",varMap["lepHt"],"tree_lepHt/F")
    tree.Branch("wQuarkHt",varMap["wQuarkHt"],"tree_wQuarkHt/F")
    tree.Branch("jetHt",varMap["jetHt"],"tree_jetHt/F")
    tree.Branch("totHt",varMap["totHt"],"tree_totHt/F")
    tree.Branch("totHtOverPt",varMap["totHtOverPt"],"tree_totHtOverPt/F")
    tree.Branch("totPt",varMap["totPt"],"tree_totPt/F")
    tree.Branch("totEta",varMap["totEta"],"tree_totEta/F")
    tree.Branch("totPtVec",varMap["totPtVec"],"tree_totPtVec/F")
    tree.Branch("totVecM",varMap["totVecM"],"tree_totVecM/F")
    tree.Branch("Channel",varMap["chan"],"tree_Channel/I")
    tree.Branch("totPt2Jet",varMap["totPt2Jet"],"tree_totPt2Jet/F")
    tree.Branch("wzdelR",varMap["wZdelR"],"tree_wzdelR/F")
    tree.Branch("wzdelPhi",varMap["wZdelPhi"],"tree_wzdelPhi/F")
    tree.Branch("zjminR",varMap["minZJetR"],"tree_zjminR/F")
    tree.Branch("zjminPhi",varMap["minZJetPhi"],"tree_zjminPhi/F")
