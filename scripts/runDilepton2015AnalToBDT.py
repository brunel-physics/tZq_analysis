...
print "python scripts/makeMVAInputDilepton.py [\\\"ee\\\",\\\"mumu\\\"] /scratch/data/TopPhysics/mvaDirs/skims/2015/mz"+mzStr+"mw"+mwStr+"/ mvaDirs/inputs/2015/"+dirExt+"mz"+mzStr+"mw"+mwStr+"/ --2015 "+useSideBandRegion
subprocess.call("python scripts/makeMVAInputDilepton.py [\\\"ee\\\",\\\"mumu\\\"] /scratch/data/TopPhysics/mvaDirs/skims/2015/mz"+mzStr+"mw"+mwStr+"/ mvaDirs/inputs/2015/"+dirExt+"mz"+mzStr+"mw"+mwStr+"/ --2015 "+useSideBandRegion ,shell=True)
