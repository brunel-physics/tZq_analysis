...
subprocess.call("python scripts/make2016MVAInputDilepton.py [\\\"ee\\\",\\\"mumu\\\"] mvaDirs/skims/2016/mz"+mzStr+"mw"+mwStr+"/ mvaDirs/inputs/2016/mz"+mzStr+"mw"+mwStr+"/ --2016 "+useSideBandRegion,shell=True)
