...
float Cuts::getBweight_backup(int flavour, int type, float pt){
  ...
  if (!is2016_){
    ...
    if (flavour == 0) { // B flavour
      if ( type == 0 ) sf = 0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x)));
      if ( type == 1 ) {
        if ( pt < 30.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.025442840531468391;
        if ( pt < 50.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.013992868363857269;
        if ( pt < 70.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.013216952793300152;
        if ( pt < 100.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.013853389769792557;
        if ( pt < 140.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.0132046053186059;
        if ( pt < 200.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.011530880816280842;
        if ( pt < 300.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.018337748944759369;
        if ( pt < 600.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.018382526934146881;
        else sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.022504275664687157;
      }
      if ( type == -1 ) {
        if ( pt < 30.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))-0.025442840531468391;
        if ( pt < 50.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))-0.013992868363857269;
    ...
    if (flavour == 1) { // C flavour
      if ( type == 0 ) sf = 0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x)));
      if ( type == 1 ) {
        if ( pt < 30.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.050885681062936783;
        if ( pt < 50.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.027985736727714539;
        if ( pt < 70.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.026433905586600304;
        if ( pt < 100.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.027706779539585114;
        if ( pt < 140.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.0264092106372118;
        if ( pt < 200.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.023061761632561684;
        if ( pt < 300.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.036675497889518738;
        if ( pt < 600.0 ) sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.036765053868293762;
        else sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))+0.045008551329374313;
      }
      if ( type == -1 ) {
        if ( pt < 30.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))-0.050885681062936783;
        if ( pt < 50.0 )  sf = (0.884095*((1.+(0.0331223*x))/(1.+(0.0284878*x))))-0.027985736727714539;
