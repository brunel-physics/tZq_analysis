...
double RocRes::kSmear(
    double pt, double eta, TYPE type, double w, double u, int n) const
{
    int H = etaBin(fabs(eta));
    int F = n - NMIN;
    if (type == Data)
...
double RoccoR::kScaleDT(
    int Q, double pt, double eta, double phi, int s, int m) const
{
    int H = etaBin(eta);
    int F = phiBin(phi);
...
double RoccoR::kScaleFromGenMCerror(
    int Q, double pt, double eta, double phi, int n, double gt, double w) const
{
...
double RoccoR::kScaleAndSmearMCerror(
    int Q, double pt, double eta, double phi, int n, double u, double w) const
{
